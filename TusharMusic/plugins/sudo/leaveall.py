...
from TusharMusic import app, userbot
from TusharMusic.misc import SUDOERS
from TusharMusic.utils.database import get_assistant, is_active_chat, get_client
from TusharMusic.core.userbot import assistants
from config import LOG_GROUP_ID as TUSHAR
